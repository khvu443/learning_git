...
using static Domain.Common.Errors.Errors;
...
namespace API.Controllers
{
    ...
    public class UserController : ApiController
    {
        ...
        {
            ErrorOr<UserResult> result = await mediator.Send(new GetByIdQuery(Guid.Parse(id)));
            ...
            UserResponse users = mapper.Map<UserResponse>(result.Value);
